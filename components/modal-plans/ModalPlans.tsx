...
function Index() {
	return (
		<DefaultModal>
			<div className="bg-white p-6 rounded-sm shadow-md text-center w-full min-w-80 max-w-120">
				<p className="py-2">Escolha o perfil</p>
				<h1 className="text-2xl font-bold text-default-purple">Buscar planos para:</h1>
